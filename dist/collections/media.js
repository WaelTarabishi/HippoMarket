...
var isAdminOrHasAcecessToImages = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, isAdminOrHasAcecessToImages()({ req: req })];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        }); },
        delete: isAdminOrHasAcecessToImages(),
        update: isAdminOrHasAcecessToImages(),
    },
    admin: {
        hidden: function (_a) {
            var user = _a.user;
