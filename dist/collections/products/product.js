    ...
    hooks: {
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createdProduct, updated, data, updatedteProduct, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            updatedteProduct = _a.sent();
                            updated = __assign(__assign({}, data), { stripeId: updatedteProduct.id, priceId: updatedteProduct.default_price });
                            return [2 /*return*/, updated];
